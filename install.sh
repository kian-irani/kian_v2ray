...
ETC_DIR="/etc/kian-v2ray"          # users.json + payload + info
XRAY_DIR="/etc/xray"               # config.json
LOG_DIR="/var/log/xray"            # لاگ‌های Xray
...
*/10 * * * * root /usr/local/bin/kian-v2ray-watchdog.sh >> /var/log/xray/watchdog.log 2>&1
CRON
