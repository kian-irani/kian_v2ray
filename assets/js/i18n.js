...
(function () {
  ...
  var DICT = {
    ...
    "g.panel.user.l": { fa: "نام کاربری پنل", en: "Panel username" },
    "g.panel.pass.l": { fa: "رمز عبور پنل", en: "Panel password" },
    "g.panel.pass.ph": { fa: "خالی = تصادفی قوی (پیشنهادی)", en: "Empty = strong random (recommended)" },
    "g.panel.hint": { fa: "پنل مدیریت وب روی سرور نصب می‌شود. بعد از نصب از آدرس <code>http://IP:8443/app</code> با این اطلاعات وارد شو. اگر رمز خالی بگذاری، یک رمز تصادفی ساخته می‌شود که در ترمینال نمایش داده خواهد شد.", en: "A web admin panel is installed on the server. After install, sign in at <code>http://IP:8443/app</code> with these credentials. If you leave the password empty, a strong random one is generated and shown in the terminal." },
    ...
    "an.s1d": { fa: "<b>Kv2m</b> (همین پروژه) و <b>Hiddify</b> همهٔ پروتکل‌های ما را روی یک لینک پشتیبانی می‌کنند: Reality، Hysteria2، TUIC، AnyTLS و ShadowTLS. اگر فقط Reality می‌خواهی، v2rayNG هم همان لینک را می‌خواند (پروتکل‌های UDP را رد می‌کند).", en: "<b>Kv2m</b> (this project) and <b>Hiddify</b> support every protocol we generate on one link: Reality, Hysteria2, TUIC, AnyTLS and ShadowTLS. If you only need Reality, v2rayNG reads the same link too (it just skips the UDP ones)." },
    "an.dl": { fa: "دانلود Kv2m ↗ · Hiddify ↗ · v2rayNG ↗", en: "Get Kv2m ↗ · Hiddify ↗ · v2rayNG ↗" },
    "an.alt": { fa: "هر کلاینتی که لینکِ Subscription می‌پذیرد کار می‌کند (NekoBox/husi، sing-box، Streisand…).", en: "Any client that accepts a subscription link works (NekoBox/husi, sing-box, Streisand…)." },
    "an.two": { fa: "دو راه داری:", en: "You have two ways:" },
    "an.copy": { fa: "• <b>لینکِ Subscription (بهترین):</b> در تب «ساخت کانفیگ» لینکِ Subscription را کپی کن، بعد در اپ: افزودن از طریق Subscription/Clipboard. همهٔ کانفیگ‌ها خودکار می‌آیند و به‌روز می‌مانند.", en: "• <b>Subscription link (best):</b> copy the subscription link from the “Build config” tab, then in the app add it via Subscription/Clipboard. All configs arrive automatically and stay up to date." },
    ...
    /* ---------- PC tab (steps) ---------- */
    "pc.s1t": { fa: "اپ Kv2m یا Hiddify رو دانلود کن (پیشنهادی)", en: "Download Kv2m or Hiddify (recommended)" },
    "pc.s1d": { fa: "<b>Kv2m</b> (ویندوز/مک/لینوکس) و <b>Hiddify</b> همهٔ پروتکل‌ها را روی یک لینک پشتیبانی می‌کنند. v2rayN هم همان لینک را برای Reality/TLS می‌خواند.", en: "<b>Kv2m</b> (Windows/macOS/Linux) and <b>Hiddify</b> support every protocol on one link. v2rayN also reads the same link for Reality/TLS." },
    "pc.dl": { fa: "دانلود Kv2m ↗ · Hiddify ↗ · v2rayN ↗", en: "Get Kv2m ↗ · Hiddify ↗ · v2rayN ↗" },
