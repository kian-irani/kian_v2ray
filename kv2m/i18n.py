...
STRINGS = {
 "en": {
  ...
  "gen.panel":"Web panel credentials (always installed — access at http://IP:8443/app)",
  "gen.paneluser":"Panel username","gen.panelpass":"Panel password (empty = strong random)",
  "gen.button":"Generate","gen.hint":"Enter your server IP and click Generate. The install command and links appear below.",
  "gen.installcmd":"Install command","gen.copy":"Copy","gen.runserver":"Run on server","gen.copyall":"Copy all links","gen.user":"User","gen.sublink":"Subscription link","gen.subdomain":"HTTPS (your own domain)",
 ...
 "fa": {
  ...
  "gen.panel":"اطلاعات ورود پنل وب (همیشه نصب می‌شود — آدرس: http://IP:8443/app)",
  "gen.paneluser":"نام کاربری پنل","gen.panelpass":"رمز پنل (خالی = تصادفی قوی)",
  "gen.button":"⚡ ساخت کانفیگ","gen.hint":"آی‌پی سرور را وارد کن و بزن ساخت. دستور نصب و لینک‌ها پایین ظاهر می‌شود.",
  "gen.installcmd":"دستور نصب","gen.copy":"کپی","gen.runserver":"اجرا روی سرور","gen.copyall":"کپی همه لینک‌ها","gen.user":"کاربر","gen.sublink":"لینک Subscription","gen.subdomain":"HTTPS (دامنهٔ خودت)",
